...
El proyecto consta de una serie de experimentos prácticos como la identificación de jerarquías de procesos mediante sus valores PID y PPID; la modificación de flujos de control para que un proceso padre incremente variables mientras el hijo registra los datos en archivos de texto; el análisis de procesos huérfanos y la implementación de soluciones para evitar que el hijo pierda su referencia al padre; finalmente, se aborda la creación de múltiples procesos hijos simultáneos realizando tareas diferenciadas y la aplicación de la familia de funciones exec para la sustitución de la imagen de memoria de un proceso hijo por una nueva tarea.
